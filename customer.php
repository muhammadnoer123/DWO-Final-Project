...
<head>
    ...
    <title>WHADVENTUREWORK2022 - Customer</title>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Jumlah Customer Tahun Ini (2004) </div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <?php
                                                    $sql = "SELECT t.tahun tahun, COUNT(fp.CustomerID) as tot_amount
                            ...
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Jumlah Customer Tahun Lalu (2003) </div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <?php
                                                    $sql = "SELECT t.tahun tahun, COUNT(fp.CustomerID) as tot_amount
                                                            FROM faktapenjualan fp
