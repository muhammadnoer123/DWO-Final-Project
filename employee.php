...
<head>
    ...
    <title>WHADVENTUREWORK2022 - Employee</title>
...
<body id="page-top">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Jumlah Employee Per Bulan</h6>
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Employee Berdasarkan Jumlah Order </h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body-store">
                                    <div class="chart-area-store">
                                        ...
                                        <?php
                                            ...
                                            $OrderQty = mysqli_query($mysqli,"SELECT DISTINCT(OrderQty), COUNT(EmployeeID) as EmployeeID FROM faktapembelian WHERE OrderQty IS NOT NULL AND OrderQty > 0 GROUP BY OrderQty ORDER BY EmployeeID DESC");
                                            while($row = mysqli_fetch_array($OrderQty)){
                                                $jenis_OrderQty[] = $row['OrderQty'];

                                                $query = mysqli_query($mysqli,"SELECT COUNT(EmployeeID) as EmployeeID FROM faktapembelian WHERE OrderQty IS NOT NULL AND OrderQty > 0 AND OrderQty='".$row['OrderQty']."'");
                        ...
                        <!-- <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Top 10 Employee Aktif</h6>
                                </div>
                                <div class="card-body-store">
                                    <div class="chart-area-store">
    ...
    <script>
        var config = {
            ...
            data: {
                datasets: [{
                    data:<?php echo json_encode($employee); ?>,
                    backgroundColor: [
                    '#050A30',
                    '#000C66',
                    '#003060',
                    ...
                    label: 'Presentase Jumlah Order Employee'
                }],
                labels: <?php echo json_encode($jenis_OrderQty); ?>},
            options: {
                responsive: true
            }
        };
    ...
    <script type="text/javascript">
        ...
        $bulan = "SELECT CONCAT(MONTHNAME(t.tanggallengkap), ' ', YEAR(t.tanggallengkap)) bulan FROM faktapembelian f JOIN time t ON f.TimeID=t.TimeID GROUP BY t.bulan ORDER BY t.tanggallengkap";
        $employee = "SELECT COUNT(f.EmployeeID) employee FROM faktapembelian f JOIN time t ON f.TimeID=t.TimeID GROUP BY t.bulan ORDER BY t.tanggallengkap";
        $i=1;
