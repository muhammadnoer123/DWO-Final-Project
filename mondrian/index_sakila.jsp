...
<body>
<p>OLAP WHAdventureWork</p>
<ul>
  <li><a href="testpage.jsp?query=faktapembelian">WHAdventureWorkPembelian</a></li>
  <li><a href="testpage.jsp?query=faktapenjualan">WHAdventureWorkPenjualan</a></li>
