...
<head>
    ...
    <title>WHADVENTUREWORK2022 - Vendor</title>
...
<body id="page-top">
  ...
  <div class="col-xl-3 col-md-6 mb-4">
                                        ...
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php  
                                                 ...
                                                 $sql = "SELECT COUNT(VendorID) as jumlah_vendor from vendor";
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Jumlah Vendor Tahun Ini (2004) </div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <?php
                                                    $sql = "SELECT t.tahun tahun, COUNT(fp.VendorID) as tot_amount
                            ...
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Jumlah Vendor Tahun Lalu (2003) </div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <?php
                                                    $sql = "SELECT t.tahun tahun, COUNT(fp.VendorID) as tot_amount
                                                            FROM faktapembelian fp
	...
	$sql = "SELECT concat('name:',f.Name) as name, concat('y:', sum(fp.LineTotal)*100/" . $tot_amount[0] .") as y, concat('drilldown:', f.Name) as drilldown
            FROM vendor f
            JOIN faktapembelian fp ON (f.VendorID = fp.VendorID)
            GROUP BY name
            ORDER BY y DESC"   ;         
            //echo $sql;
    ...
    $sql = "SELECT f.Name kategori, sum(fp.LineTotal) as tot_kat
            FROM faktapembelian fp
            JOIN vendor f ON (f.VendorID = fp.VendorID)
            GROUP BY kategori";
