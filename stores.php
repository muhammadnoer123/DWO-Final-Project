...
<head>
    ...
    <title>WHADVENTUREWORK2022 - Store</title>
...
<body id="page-top">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Jumlah Transaksi di Toko A Bike Store</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php  
                                                 ...
                                                 $sql = "SELECT COUNT(StoreID) jml_trans1 FROM faktapenjualan WHERE StoreID=1";
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Jumlah Transaksi di Toko Progressive Sports</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <?php
                                             $sql = "SELECT COUNT(StoreID) jml_trans2 FROM faktapenjualan WHERE StoreID=2";
                                             $query = mysqli_query($mysqli,$sql);
                                             while($row2=mysqli_fetch_array($query)){
                            ...
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Jumlah Transaksi di Toko Advanced Bike Components</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <?php
                                             $sql = "SELECT COUNT(StoreID) jml_trans3 FROM faktapenjualan WHERE StoreID=3";
                                             $query = mysqli_query($mysqli,$sql);
                                             while($row2=mysqli_fetch_array($query)){
                                                echo number_format($row2['jml_trans3'],0,".",",");
                                             }
                                            ?>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Jumlah Transaksi pada  Store Tahun Ini (2004)</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <?php
                                                    $sql = "SELECT COUNT(fp.StoreID) jml_peminjaman, t.tahun FROM faktapenjualan fp JOIN time t ON fp.TimeID=t.TimeID WHERE t.tahun='2004' GROUP BY t.tahun";
                                                     $query = mysqli_query($mysqli,$sql);
                                                        while($row2=mysqli_fetch_array($query)){
	...
	$sql = "SELECT concat('name:',f.Name) as name, concat('y:', sum(fp.LineTotal)*100/" . $tot_amount[0] .") as y, concat('drilldown:', f.Name) as drilldown
            FROM store f
            JOIN faktapenjualan fp ON (f.StoreID = fp.StoreID)
            GROUP BY name
            ORDER BY y DESC"   ;         
            //echo $sql;
    ...
    $sql = "SELECT f.Name kategori, sum(fp.LineTotal) as tot_kat
            ...
            JOIN store f ON (f.StoreID = fp.StoreID)
            GROUP BY kategori";
